...
public class Caminhao extends BaseVeiculo{
    ...
    public Caminhao(int codigo, String nome, String modelo, String cor, String chassi, String anoModelo,
            ...
            String documentos, int porta, String carga, int volante) {
